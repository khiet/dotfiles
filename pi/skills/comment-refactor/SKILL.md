...
description: Refactor code comments added by a branch or commit so they explain intent, constraints, and domain terms clearly, following the comment guidance in pi/AGENTS.md. Use when the user asks to clean up, review, or refactor comments, or runs `/comment_refactor`.
---
# Comment Refactor
